import numpy as np
from miv_simulator.geometry.geometry import make_alpha_shape, transform_volume
from miv_simulator.geometry.linear_volume import LinearVolume
...
def make_network_volume(
    ...
    xyz, obs_u, obs_v, obs_l = network_meshgrid(
        extent_u,
        extent_v,
        extent_l,
        rotate=rotate,
