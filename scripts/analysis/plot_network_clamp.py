...
from miv_simulator.utils import Context, is_interactive
...
@click.option(
    "--target-input-features-namespace",
    type=str,
    default="Selectivity Features",
)
...
def main(
    ...
    target_input_features_arena_id,
    target_input_features_trajectory_id,
    gid,
    n_trials,
    spike_hist_bin,
    all_spike_hist,
    ...
    plot.plot_network_clamp(
        ...
        all_spike_hist=all_spike_hist,
        spike_hist_bin=spike_hist_bin,
        labels=labels,
        lowpass_plot_type=lowpass_plot_type,
        n_trials=n_trials,
        fontSize=font_size,
        legend=legend,
        saveFig=True,
