...
@click.option("--stimulus-id", required=False, type=str,
              help='name of input stimulus')
...
def main(arena_id, cell_selection_path, config_file, template_paths, hoc_lib_path, dataset_prefix, config_prefix,
         results_path, results_id, node_rank_file, io_size, use_cell_attr_gen, cell_attr_gen_cache_size, recording_profile, output_syn_spike_count,
         use_coreneuron, stimulus_id, tstop, v_init, stimulus_onset, max_walltime_hours, microcircuit_inputs, 
